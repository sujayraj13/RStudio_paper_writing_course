...
e.g., (\emph{1}), or by switching to the visual editor (Cogwheel in the
.Rmd menu -\textgreater{} Use Visual Editor).
{[}(\emph{2}){]}(\emph{2})(\emph{3})
...
\emph{Platynereis dumerilii} is a marine annelid\ldots{} (\emph{4})
...
\CSLLeftMargin{1. }%
\CSLRightInline{M. Marinković, J. Berger, G. Jékely,
...
Transactions of the Royal Society B: Biological Sciences} \textbf{375},
20190165 (2019).}

\bibitem[\citeproctext]{ref-Jokura_2023}
\CSLLeftMargin{2. }%
\CSLRightInline{K. Jokura, N. Ueda, M. Gühmann, L. A. Yañez-Guerra, P.
Słowiński, K. C. A. Wedgwood, G. Jékely, Nitric oxide feedback to
ciliary photoreceptor cells gates a UV avoidance circuit. doi:
\href{https://doi.org/10.7554/elife.91258.1}{10.7554/elife.91258.1}
(2023).}

\bibitem[\citeproctext]{ref-Jacobs2023}
\CSLLeftMargin{3. }%
\CSLRightInline{E. A. K. Jacobs, S. Ryu,
...
research}. \emph{Frontiers in Behavioral Neuroscience} \textbf{17}
(2023).}

\bibitem[\citeproctext]{ref-ozpolat2021}
\CSLLeftMargin{4. }%
\CSLRightInline{B. D. Ozpolat, N. Randel, E. A. Williams, L. A.
Bezares-Calderón, G. Andreatta, G. Balavoine, P. Y. Bertucci, D. E. K.
Ferrier, M. C. Gambi, E. Gazave, M. Handberg-Thorsager, J. Hardege, C.
Hird, Y.-W. Hsieh, J. Hui, K. N. Mutemi, S. Q. Schneider, O. Simakov, H.
M. Vergara, M. Vervoort, G. Jékely, K. Tessmar-Raible, F. Raible, D.
Arendt, The Nereid on the rise: Platynereis as a model system.
\emph{Zenodo}, doi:
\href{https://doi.org/10.5281/ZENODO.4907400}{10.5281/ZENODO.4907400}
(2021).}
