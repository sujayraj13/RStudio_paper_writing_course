...
This table was generated by tt() as the output of an r chunk in a Quarto doc. 
For larger multi-page tables, this method gives correct page breaks in the pdf and html outputs.
You can change the relative column widths with  {tbl-colwidths="[10,20,20,20,30]"} placed after the table caption declaration at the end.
